    ...
    <footer className="text-center py-5 mt-auto " >
      <Container>
        <Row className="align-items-center justify-content-around">
          ...
          <Image src={ darkMode ? "/images/perceptia_logo_negative.jpg" : "/images/perceptia_logo.jpg"} alt="Perceptia Press" className="img-fluid" width={30} height={40} />
            {/* Copyright */}
            <p className="mb-0" style={{ fontSize: '0.5rem' }}>© {new Date().getFullYear()} Perceptia Press</p>
          </Col>
        </Row>
      </Container>
    </footer>
